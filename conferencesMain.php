                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="submit" class="btn-outline-success" type="button" data-bs-dismiss="modal" name="submit">Oui</button>
...
<?php
   // include_once("db_config.php");
    ...
    if (isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['tel']) && isset($_POST['email']) && isset($_POST['titre']) ) { 
      ...
      $titre = htmlspecialchars($_POST['titre']);
        ...
        try{
            $requete->execute(array($nom, $prenom, $tel, $email, $titre));
        } catch(Exception $e){
          $data = array(
...
?>
  <script>
    const phpData = <?php echo $jsonData["message"]; ?>;
    if (phpData.message == "Req" ) {
